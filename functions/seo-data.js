...
const ROUTE_META = {
  "/": {
    title: "AI Dating Profile Audit, Bio Generator & Photo Score | SwipeBetter.ai",
    description: "Optimize your dating profile with AI. Get a professional 0-100 profile score, generate high-converting bios, and master your chats.",
    h1: "AI Dating Profile Audit",
    intro: "Upload dating profile screenshots and get clear AI feedback on your photos, bio, prompts, and replies for Tinder, Hinge, Bumble, and more.",
    type: "software",
  },
  "/pricing": {
    title: "SwipeBetter Pricing | AI Dating Profile Audit Plans",
    description: "Choose a SwipeBetter plan for AI dating profile audits, profile scores, bio suggestions, and conversation help.",
    h1: "SwipeBetter Pricing",
    intro: "Compare SwipeBetter plans for profile audits, bio rewrites, dating photo feedback, and AI reply suggestions.",
    type: "software",
  },
  "/blog": {
  ...
  "/tools/tinder-bio-generator": {
    title: "AI Tinder Bio Generator | Free Dating Bio Writer",
    description: "Generate custom Tinder bio ideas with AI. Get dating bios tailored to your personality, goals, and dating app style.",
    h1: "AI Tinder Bio Generator",
    intro: "Create Tinder, Bumble, and Hinge bio options that sound natural, show personality, and give matches an easy reason to reply.",
    type: "software",
  },
  "/tools/hinge-prompt-writer": {
    title: "Hinge Prompt Writer | AI Hinge Answer Generator",
    description: "Generate witty, original Hinge prompt answers with AI for prompts like Dating me is like, Two truths and a lie, and more.",
    h1: "Hinge Prompt Writer",
    intro: "Turn flat Hinge prompts into specific, conversational answers that make it easier for matches to start a real conversation.",
    type: "software",
  },
  "/tools/dating-photo-analyzer": {
    title: "AI Dating Photo Analyzer | Rate Tinder & Hinge Photos",
    description: "Get AI feedback on dating profile photos, lighting, trust signals, expression, and photo order for better matches.",
    h1: "AI Dating Photo Analyzer",
    intro: "Review your dating photos for first-photo strength, expression, lighting, authenticity, and lineup order before you upload them.",
    type: "software",
  },
  "/fix-profile": {
    title: "Fix Your Dating Profile | AI Tinder, Hinge & Bumble Audit",
    description: "Get an AI dating profile audit with a 0-100 score, photo feedback, red flags, and bio improvement suggestions.",
    h1: "Fix Your Dating Profile",
    intro: "Upload profile screenshots and get an instant AI audit with a score, photo notes, bio feedback, and specific fixes.",
    type: "software",
  },
  "/fix-reply": {
    title: "Fix Your Dating App Reply | AI Texting Assistant",
    description: "Paste a dating app conversation and get AI reply suggestions that sound playful, confident, or flirty.",
    h1: "Fix Your Reply",
    intro: "Get context-aware replies for Tinder, Hinge, Bumble, and other dating app conversations without sounding generic.",
    type: "software",
  },
  "/blog/why-am-i-getting-no-matches": {
  ...
  "/hinge-profile-tips": {
    title: "Hinge Profile Tips | Improve Photos, Prompts & Matches",
    description: "Optimize your Hinge profile with stronger photos, better prompts, clearer intent, and conversation-friendly details.",
    h1: "Hinge Profile Tips",
    intro: "Improve each part of your Hinge profile so your photos, prompts, and signals work together instead of fighting each other.",
    type: "article",
  },
  "/bumble-bio-examples": {
  ...
  "/tinder-photo-order": {
    ...
    description: "Learn the best Tinder photo order, what your first photo should do, and which photos to move or remove.",
    h1: "Best Tinder Photo Order",
    intro: "Your first photo earns the swipe, but your full lineup earns trust. Use this guide to order photos more strategically.",
    type: "article",
  },
  "/what-to-text-after-matching": {
