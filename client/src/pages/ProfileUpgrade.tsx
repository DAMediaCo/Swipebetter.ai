...
export default function ProfileUpgrade() {
  ...
  useEffect(() => {
    const analysis = loadAnalysis('profile');
    if (!analysis) {
    ...
    <div className="min-h-screen pb-24 md:pb-8">
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <Card className="mb-6">
          <CardContent className="pt-8 pb-6 text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Get unlimited analyses and advanced AI insights to perfect your dating profile.
            </p>
          </CardContent>
        </Card>
        ...
        <div className="flex gap-3">
          <Link href="/fix-profile/results" className="flex-1">
            <Button
              variant="outline"
              className="w-full"
